const platformFlows = {
  ...
  微信视频号: { loginUrl: 'https://channels.weixin.qq.com/platform', sessionCookies: ['wxuin', 'slave_sid', 'uin', 'pass_ticket'], selectors: ['[class*="avatar"]', '[class*="account"]', '[class*="nickname"]'] },
  ...
  哔哩哔哩: { loginUrl: 'https://member.bilibili.com/platform/upload/video/frame', sessionCookies: ['SESSDATA', 'bili_jct', 'DedeUserID'], selectors: ['[class*="avatar"]', '[class*="user-name"]', '[class*="header"]'] },
